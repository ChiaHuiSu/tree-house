...
namespace Treehierarchy
{
    ...
    protected:
        ...
        FunctionType getTreeFunctionType() override {             
            ...
            Type resultType = getPointerType();
    ...
    void XGBoostParser::CreatePredictFunction()
    {
        ...
        {            
            ...
            std::string callString = "tree_" + std::to_string(i);
            StringRef callName(callString);
            auto callResult = m_builder.create<func::CallOp>(loc, callName, getF32(), operands);
            auto callAttr = FlatSymbolRefAttr::get(m_builder.getContext(), callName);
            callResult->setAttr(callName, callAttr);
